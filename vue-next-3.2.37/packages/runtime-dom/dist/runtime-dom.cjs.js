...
const rendererOptions$1 = /*#__PURE__*/ shared.extend({ patchProp }, nodeOps);
// lazy create the renderer - this makes core renderer logic tree-shakable
// in case the user only imports reactivity utilities from Vue.
let renderer$1;
...
function ensureRenderer$1() {
    return (renderer$1 ||
        (renderer$1 = runtimeCore.createRenderer(rendererOptions$1)));
}
function ensureHydrationRenderer$1() {
    renderer$1 = enabledHydration$1
        ? renderer$1
        : runtimeCore.createHydrationRenderer(rendererOptions$1);
